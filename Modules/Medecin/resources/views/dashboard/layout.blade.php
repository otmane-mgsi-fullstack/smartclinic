...
<aside class="sidebar">
    ...
    <div class="nav-link active"><a href="{{route('medecin.dispo')}}"><i class="bi bi-grid-1x2"></i> </a>Tableau de bord</div>
    <div class="nav-link"><i class="bi bi-calendar-week"></i> Mon planning</div>
